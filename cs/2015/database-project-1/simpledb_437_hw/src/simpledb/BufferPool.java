...
/*
	...
	try//how to detect aborted transaction?
		{
		;
		}
	catch(TransactionAbortedException e)
		{
		System.out.println("Detected aborted transaction");
		System.out.println("TransactionAbortedExpression e:");
		System.out.println(e);
		System.out.println("returning null from getPage()");
		return null;
		}
	//throws DbException
	try//how to detect database exception?
		{
		;
		}
	catch(DbException e)
		{
		System.out.println("Detected database exception");
	...
	//throws IOException
	try//how to detect input or output exception
		{
		;
		}
	catch(IOException e)
		{
		System.out.println("Detected input or output exception");
		System.out.println("IOException e:");
		System.out.println(e);
		System.out.println("returning null from getPage()");
		return null;
		}
	//done handling exeptions
	//proceed to primary phase

	//getPage()
	//
	//should have detected conditions to throw any of the
	//three throwable exceptions
	//
	//	transaction aborted
	//	database exception
	//	i/o exception
...
/*
 * eviction policy dependent on 0 is default, 1 LRU, 2 MRU
 * detect policy using switch(eviction_policy)
 *
 * how do we deal with eviction policy changing partway through
 *
 * depending on policy evict
 * 	most recently used
 * 	least recently used
 * 	if no policy set (zero) default to first page, random page, arbitrary
 */	
